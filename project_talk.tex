...
\end{figure}
  ...
  \tikzstyle{transition}=[rectangle,thick,draw=black!75,
    ...
    \node [transition] (t1) [right of=p1, label=above:$action1$] {}  edge [pre] (p1);
    \node [place] (p2)  [right of=t1] {} edge [pre] (t1);
    \node [transition] (p3) [below of=t1, label=below:$action2$] {} edge [pre] (p1) edge [post] (p2);
\end{tikzpicture}
\caption{Result!!!}
\end{figure}
 ...
 \begin{figure}
  ...
  \tikzstyle{transition}=[rectangle,thick,draw=black!75,
        fill=black!20,minimum size=4mm]
    \node [place,tokens=1] (p1){};
    \node [transition] (t1) [right of=p1, label=below:$action1$] {}  edge [pre] (p1);
    \node [place] (p2)  [right of=t1] {} edge [pre] (t1);
    \node [transition] (p3) [above of=t1, label=above:$action2$] {} edge [pre] (p1) edge [post] (p2);
\end{tikzpicture}
\caption{Result!!!}
\end{figure}
  \end{column}
