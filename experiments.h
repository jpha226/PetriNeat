...
bool petrinet_evaluate(Organism *org);		// Returns the value generated by the fitness function after a simulation was performed on the organism
int petrinet_epoch(Population *pop, int generation, char *filename, int &winnernum, int &winnergenes, int &winnernodes);

int displaySimulationVar;
